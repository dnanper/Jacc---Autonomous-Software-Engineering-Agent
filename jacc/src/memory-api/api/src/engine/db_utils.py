...
async def retry_with_backoff(
    ...
    base_delay: float = DEFAULT_DB_BASE_DELAY,
    max_delay: float = DEFAULT_DB_MAX_DELAY,
...
@asynccontextmanager
async def acquire_with_retry(pool: asyncpg.Pool, max_retries: int = DEFAULT_DB_MAX_RETRIES):
    """
