"""
HTTP Extension for adding custom endpoints to the Memory API.
...
class HttpExtension(Extension, ABC):
    ...
    Example:
        ```python
        from fastapi import APIRouter
        from src.extensions import HttpExtension
    ...
    Configuration via environment variables:
        API_HTTP_EXTENSION=mypackage.ext:MyHttpExtension
        API_HTTP_SOME_CONFIG=value
