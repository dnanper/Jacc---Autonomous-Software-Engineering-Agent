...
if TYPE_CHECKING:
    ...
    from src.engine.response_models import RecallResult as RecallResultModel
    from src.engine.response_models import ReflectResult
...
class OperationValidatorExtension(Extension, ABC):
    ...
    Enable via environment variable:
        API_OPERATION_VALIDATOR_EXTENSION=mypackage.validators:MyValidator

    Configuration is passed from prefixed environment variables:
        API_OPERATION_VALIDATOR_MAX_REQUESTS=100
