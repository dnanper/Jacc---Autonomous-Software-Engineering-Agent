...
from src.extensions.tenant import AuthenticationError, TenantContext, TenantExtension
...
class ApiKeyTenantExtension(TenantExtension):
    ...
    1. Validates the API key matches API_TENANT_API_KEY
    ...
    def __init__(self, config: dict[str, str]):
        ...
        if not self.expected_api_key:
            raise ValueError("API_TENANT_API_KEY is required when using ApiKeyTenantExtension")
